...
public final class BareboneDao implements DatabaseAccessObject{
    private static BareboneDao instance;
    ...
    public static BareboneDao getInstance(String username, String password) {
        if (username == null || password == null)
            throw new NullPointerException("username/password combination is invalid");
        if (instance == null)
            instance = new BareboneDao();
    ...
    private static void init(String username, String password) {
        ...
        try {
            instance.c = DriverManager.getConnection("jdbc:oracle:thin:@" + rHost + ":" + lPort + ":" + sid, username, password);
        } catch (Exception e) {
